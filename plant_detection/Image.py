...
class Image(object):
    ...
    def load(self, filename):
        ...
        image = cv2.resize(image, (800, 600))  # or adaptive resize
    ...
    def find(self, calibration=False, safe_remove=False,draw_contours=True):
        ...
        self.detected_contours = valid_contours
